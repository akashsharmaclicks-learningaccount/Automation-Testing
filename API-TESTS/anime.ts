...
fixture`Anime-APIs-Testing`;

test.skip("Complete test of films API", async (t) => {
  try {
...
test.skip("Complete test of people API", async (t) => {
  try {
    const result = await t.request({
...
test.skip("Complete test of location API", async (t) => {
  try {
    const result = await t.request({
...
test.skip("Complete test of species API", async (t) => {
  try {
    const result = await t.request({
...
test.skip("Complete test of vehicles API", async (t) => {
  try {
    const result = await t.request({
