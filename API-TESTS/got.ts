...
fixture`GOT-APIs-Testing`;

test("Complete test of GOT-Characters API", async (t) => {
  try {
...
test("Complete test of GOT-Books API", async (t) => {
  try {
    const result = await t.request({
...
test("Complete test of GOT-Houses API", async (t) => {
  try {
    const result = await t.request({
