...
import { generateRandomDomainName } from "../generate-random";
fixture`Domain-Logo-APIs-Testing`;
const domain = generateRandomDomainName();
test("Complete test of Domain-Logo API", async (t) => {
  try {
